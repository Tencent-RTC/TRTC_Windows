...
namespace TRTCCSharpDemo
{
    public partial class AudioSettingForm : Form
    {
        ...
        public void OnDeviceChange(string deviceId, TXMediaDeviceType type, TXMediaDeviceState state)
        {
            if (type == TXMediaDeviceType.TXMediaDeviceTypeMic)
            {
                RefreshMicDeviceList();
            }
            else if (type == TXMediaDeviceType.TXMediaDeviceTypeSpeaker)
            {
                RefreshSpeakerList();
            }
        }
